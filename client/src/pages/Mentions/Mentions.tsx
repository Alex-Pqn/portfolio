...
function Mentions() {
  ...
  return (
    <>
      {/* Head */}
      <Helmet>
        <title>Mentions légales • Alexandre Paquien</title>
      </Helmet>
        ...
        >
          ...
          >
            ...
            <p>
              ...
              susceptibles d’être détenues par <a href={siteUrl}>{siteUrl}</a>{' '}
          ...
          >
            ...
            <p>
              ...
              aux utilisateurs du site internet <a href={siteUrl}>{siteUrl}</a>{' '}
              l&apos;identité des différents intervenants dans le cadre de sa
              réalisation et de son suivi:
            </p>
            <p>
              <strong>Propriétaire</strong> : Alexandre Paquien – 38470 Vinay
            </p>
            <p>
              <strong>Responsable publication</strong> : Alexandre Paquien –{' '}
            ...
            <p>
              <strong>Webmaster</strong> : Alexandre Paquien –{' '}
              <a href={`mailto:${email}`}>{email}</a>
            </p>
            <p>
          ...
          >
            ...
            <p>
              L’utilisation du site <a href={siteUrl}>{siteUrl}</a> implique
              ...
              utilisateurs du site <a href={siteUrl}>{siteUrl}</a> sont donc
            ...
            <p>
              ...
              <a href={siteUrl}>{siteUrl}</a>, qui s’efforcera alors de
              communiquer préalablement aux utilisateurs les dates et heures de
              l’intervention. Le site web <a href={siteUrl}>{siteUrl}</a> est
              mis à jour régulièrement par <a href={siteUrl}>{siteUrl}</a>{' '}
          ...
          >
            ...
            <p>
              Le site internet <a href={siteUrl}>{siteUrl}</a> a pour objet de
              fournir une information concernant l’ensemble des activités de la
              société.
              <a href={siteUrl}>{siteUrl}</a> s’efforce de fournir sur le site{' '}
              <a href={siteUrl}>{siteUrl}</a> des informations aussi précises
              que possible. Toutefois, il ne pourra être tenu responsable des
              oublis, des inexactitudes et des carences dans la mise à jour,
            ...
            <p>
              ...
              <a href={siteUrl}>{siteUrl}</a> sont données à titre indicatif, et
              sont susceptibles d’évoluer. Par ailleurs, les renseignements
              figurant sur le site <a href={siteUrl}>{siteUrl}</a> ne sont pas
          ...
          >
            ...
            <p>
              ...
              Le site <a href={siteUrl}>{siteUrl}</a> est hébergé chez un
            ...
            <p>
              <a href={siteUrl}>{siteUrl}</a> et l’hébergeur ne pourront être
              tenus responsables en cas de dysfonctionnement du réseau Internet,
          ...
          >
            ...
            <p>
              <a href={siteUrl}>{siteUrl}</a> est propriétaire des droits de
              ...
              écrite préalable de : <a href={siteUrl}>{siteUrl}</a>.
            </p>
          ...
          >
            ...
            <p>
              <a href={siteUrl}>{siteUrl}</a> agit en tant qu’éditeur du site.{' '}
              <a href={siteUrl}>{siteUrl}</a> est responsable de la qualité et
              de la véracité du Contenu qu’il publie.{' '}
            </p>

            <p>
              <a href={siteUrl}>{siteUrl}</a> ne pourra être tenu responsable
              des dommages directs et indirects causés au matériel de
              l’utilisateur, lors de l’accès au site internet{' '}
              <a href={siteUrl}>{siteUrl}</a>, et résultant soit de
            ...
            <p>
              <a href={siteUrl}>{siteUrl}</a> ne pourra également être tenu
              responsable des dommages indirects (tels par exemple qu’une perte
              de marché ou perte d’une chance) consécutifs à l’utilisation du
              site <a href={siteUrl}>{siteUrl}</a>. Des espaces interactifs
              (possibilité de poser des questions dans l’espace contact) sont à
              la disposition des utilisateurs. <a href={siteUrl}>{siteUrl}</a>{' '}
              ...
              <a href={siteUrl}>{siteUrl}</a> se réserve également la
          ...
          >
            ...
            <p>
              ...
              est : Alexandre Paquien. <a href={siteUrl}>{siteUrl}</a> est
              représenté par Alexandre Paquien, son représentant légal.
            </p>
            <p>
              En tant que responsable du traitement des données qu’il collecte,{' '}
              <a href={siteUrl}>{siteUrl}</a> s’engage à respecter le cadre des
              ...
              <a href={siteUrl}>{siteUrl}</a> traite des Données Personnelles,{' '}
              <a href={siteUrl}>{siteUrl}</a> prend toutes les mesures
              raisonnables pour s’assurer de l’exactitude et de la pertinence
          ...
          >
            ...
            <ul>
              ...
              <li>
                ...
                <a href={siteUrl}>{siteUrl}</a> : adresse email{' '}
              </li>
              <li>
            ...
            <p>
              <a href={siteUrl}>{siteUrl}</a> ne commercialise pas vos données
          ...
          >
            ...
            <p>
              ...
              Utilisateurs de <a href={siteUrl}>{siteUrl}</a> disposent des
              droits suivants :{' '}
            </p>
            <ul>
              <li>
              ...
              <li>
                ...
                mort et de choisir à qui <a href={siteUrl}>{siteUrl}</a> devra
                communiquer (ou non) ses données à un tiers qu’ils aura
                préalablement désigné
              </li>
            </ul>
            <p>
              Dès que <a href={siteUrl}>{siteUrl}</a> a connaissance du décès
              d’un Utilisateur et à défaut d’instructions de sa part,{' '}
              <a href={siteUrl}>{siteUrl}</a> s’engage à détruire ses données,
              sauf si leur conservation s’avère nécessaire à des fins
              probatoires ou pour répondre à une obligation légale.
            </p>
            <p>
              Si l’Utilisateur souhaite savoir comment{' '}
              <a href={siteUrl}>{siteUrl}</a> utilise ses Données Personnelles,
              demander à les rectifier ou s’oppose à leur traitement,
              l’Utilisateur peut contacter <a href={siteUrl}>{siteUrl}</a> par
              écrit à l’adresse suivante :{' '}
            </p>
            Alexandre Paquien – DPO, Alexandre Paquien <br />
            38470 Vinay.
            <p>
              Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles
              qu’il souhaiterait que <a href={siteUrl}>{siteUrl}</a> corrige,
            ...
            <p>
              ...
              <a href={siteUrl}>{siteUrl}</a> par la loi, notamment en matière
              de conservation ou d’archivage des documents. Enfin, les
              Utilisateurs de <a href={siteUrl}>{siteUrl}</a> peuvent déposer
          ...
          >
            ...
            <p>
              ...
              transférer les Informations collectées sur ses Clients vers un
              pays situé en dehors de l’Union européenne ou reconnu comme « non
              adéquat » par la Commission européenne sans en informer
              préalablement le client. Pour autant,{' '}
              <a href={siteUrl}>{siteUrl}</a> reste libre du choix de ses
            ...
            <p>
              <a href={siteUrl}>{siteUrl}</a> s’engage à prendre toutes les
              précautions nécessaires afin de préserver la sécurité des
              Informations et notamment qu’elles ne soient pas communiquées à
              ...
              portée à la connaissance de <a href={siteUrl}>{siteUrl}</a>,
              ...
              <a href={siteUrl}>{siteUrl}</a> ne collecte aucune « données
              sensibles ».
            </p>
            <p>
              Les Données Personnelles de l’Utilisateur peuvent être traitées
              par des filiales de <a href={siteUrl}>{siteUrl}</a> et des
            ...
            <p>
              ...
              <a href={siteUrl}>{siteUrl}</a> sont principalement les agents de
          ...
          >
            ...
            <p>
              ...
              <a href={siteUrl}>{siteUrl}</a> n&apos;est publiée à l&apos;insu
              de l&apos;utilisateur, échangée, transférée, cédée ou vendue sur
              un support quelconque à des tiers. Seule l&apos;hypothèse du
              rachat de <a href={siteUrl}>{siteUrl}</a> et de ses droits
              ...
              vis de l&apos;utilisateur du site <a href={siteUrl}>{siteUrl}</a>.
            </p>
            <h3>Sécurité</h3>
            <p>
              Pour assurer la sécurité et la confidentialité des Données
              Personnelles et des Données Personnelles de Santé,{' '}
              <a href={siteUrl}>{siteUrl}</a> utilise des réseaux protégés par
              des dispositifs standards tels que par pare-feu, la
          ...
          >
            ...
            <p>
              Le site <a href={siteUrl}>{siteUrl}</a> contient un certain nombre
              de liens hypertextes vers d’autres sites, mis en place avec
              l’autorisation de <a href={siteUrl}>{siteUrl}</a>. Cependant,{' '}
              <a href={siteUrl}>{siteUrl}</a> n’a pas la possibilité de vérifier
          ...
          >
            ...
            <p>
              ...
              enregistré dans son terminal. <a href={siteUrl}>{siteUrl}</a>{' '}
            ...
            <p>
              ...
              également être le cas lorsque <a href={siteUrl}>{siteUrl}</a> ou
            ...
            <p>
              Le cas échéant, <a href={siteUrl}>{siteUrl}</a> décline toute
              responsabilité pour les conséquences liées au fonctionnement
              dégradé du Site et des services éventuellement proposés par{' '}
              <a href={siteUrl}>{siteUrl}</a>, résultant (i) du refus de Cookies
              par l’Utilisateur (ii) de l’impossibilité pour{' '}
              <a href={siteUrl}>{siteUrl}</a> d’enregistrer ou de consulter les
              Cookies nécessaires à leur fonctionnement du fait du choix de
              l’Utilisateur. Pour la gestion des Cookies et des choix de
            ...
            <p>
              ...
              modifier ses souhaits en matière de Cookies.{' '}
              <a href={siteUrl}>{siteUrl}</a> pourra en outre faire appel aux
              services de prestataires externes pour l’aider à recueillir et
              traiter les informations décrites dans cette section.
            </p>
            <p>
              Enfin, en cliquant sur les icônes dédiées aux réseaux sociaux
              Twitter, Facebook, Github, Linkedin et Google Plus figurant sur le
              Site de <a href={siteUrl}>{siteUrl}</a> ou dans son application
              mobile et si l’Utilisateur a accepté le dépôt de cookies en
              poursuivant sa navigation sur le Site Internet ou l’application
              mobile de <a href={siteUrl}>{siteUrl}</a>, Twitter, Facebook,
              Github, Linkedin et Google Plus peuvent également déposer des
            ...
            <p>
              ...
              <a href={siteUrl}>{siteUrl}</a>. À tout moment, l’Utilisateur peut
          ...
          >
            ...
            <p>
              ...
              des balises Internet (également appelées « tags », ou balises
              d’action, GIF à un pixel, GIF transparents, GIF invisibles et GIF
              un à un) et les déployer par l’intermédiaire d’un partenaire
              spécialiste d’analyses Web susceptible de se trouver (et donc de
              stocker les informations correspondantes, y compris l’adresse IP
            ...
            <p>
              Cette technologie permet à <a href={siteUrl}>{siteUrl}</a>{' '}
            ...
            <p>
              ...
              Site à l’attention de <a href={siteUrl}>{siteUrl}</a>, et fournir
          ...
          >
            ...
            <p>
              ...
              <a href={siteUrl}>{siteUrl}</a> est soumis au droit français. En
